...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260514082350_AddAgencies")]
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3803),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3813)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3816),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3816)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3817),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3818)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3819),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3819)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3820),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 14, 11, 23, 50, 178, DateTimeKind.Local).AddTicks(3820)
                        });
                });
