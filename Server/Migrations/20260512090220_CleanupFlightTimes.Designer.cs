...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512090220_CleanupFlightTimes")]
    partial class CleanupFlightTimes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8145),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8182)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8185),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8185)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8186),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8187)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8188),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8188)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8189),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 2, 20, 288, DateTimeKind.Local).AddTicks(8189)
                        });
                });
