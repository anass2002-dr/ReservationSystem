...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512114315_AddPickupDetails")]
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4383),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4401)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4404),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4405)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4406),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4407)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4408),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4408)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4410),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 14, 43, 14, 615, DateTimeKind.Local).AddTicks(4410)
                        });
                });
