...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260514105236_AddIdentityAndAudit")]
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 14, 10, 52, 35, 988, DateTimeKind.Utc).AddTicks(9073),
                            IsActive = true,
                            Time = "08:30"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 14, 10, 52, 35, 988, DateTimeKind.Utc).AddTicks(9940),
                            IsActive = true,
                            Time = "10:30"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 14, 10, 52, 35, 988, DateTimeKind.Utc).AddTicks(9942),
                            IsActive = true,
                            Time = "13:00"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 14, 10, 52, 35, 988, DateTimeKind.Utc).AddTicks(9943),
                            IsActive = true,
                            Time = "15:00"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 14, 10, 52, 35, 988, DateTimeKind.Utc).AddTicks(9944),
                            IsActive = true,
                            Time = "17:00"
                        });
                });
