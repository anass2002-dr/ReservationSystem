...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512102650_RemoveCountryEntity")]
    partial class RemoveCountryEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7342),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7360)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7364),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7364)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7366),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7366)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7367),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7368)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7369),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 26, 49, 444, DateTimeKind.Local).AddTicks(7369)
                        });
                });
