...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260519133537_AddPilotFlightTracking")]
    partial class AddPilotFlightTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 19, 13, 35, 34, 138, DateTimeKind.Utc).AddTicks(322),
                            IsActive = true,
                            Time = "08:30"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 19, 13, 35, 34, 138, DateTimeKind.Utc).AddTicks(1182),
                            IsActive = true,
                            Time = "10:30"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 19, 13, 35, 34, 138, DateTimeKind.Utc).AddTicks(1184),
                            IsActive = true,
                            Time = "13:00"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 19, 13, 35, 34, 138, DateTimeKind.Utc).AddTicks(1185),
                            IsActive = true,
                            Time = "15:00"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 19, 13, 35, 34, 138, DateTimeKind.Utc).AddTicks(1186),
                            IsActive = true,
                            Time = "17:00"
                        });
                });
