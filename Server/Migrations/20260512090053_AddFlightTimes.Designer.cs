...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512090053_AddFlightTimes")]
    partial class AddFlightTimes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7581),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7597)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7601),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7601)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7603),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7603)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7605),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7605)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7607),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 0, 52, 620, DateTimeKind.Local).AddTicks(7607)
                        });
                });
