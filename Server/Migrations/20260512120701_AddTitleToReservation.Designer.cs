...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512120701_AddTitleToReservation")]
    partial class AddTitleToReservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5501),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5518)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5522),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5523)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5524),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5525)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5527),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5527)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5528),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 7, 1, 308, DateTimeKind.Local).AddTicks(5529)
                        });
                });
