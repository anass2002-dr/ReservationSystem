...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260513102354_AddPilotGroups")]
    partial class AddPilotGroups
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7173),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7195)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7199),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7200)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7202),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7202)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7203),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7204)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7205),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 13, 13, 23, 53, 426, DateTimeKind.Local).AddTicks(7206)
                        });
                });
