...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512124020_AddNotesToPayment")]
    partial class AddNotesToPayment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2263),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2280)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2283),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2283)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2284),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2285)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2286),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2286)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2287),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 15, 40, 19, 484, DateTimeKind.Local).AddTicks(2287)
                        });
                });
