...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512104134_AddNotesToReservation")]
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(414),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(434)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(438),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(439)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(440),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(441)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(442),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(442)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(444),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 13, 41, 33, 813, DateTimeKind.Local).AddTicks(444)
                        });
                });
