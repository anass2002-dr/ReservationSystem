...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260512090527_AddFlightTimesAndSlots")]
    partial class AddFlightTimesAndSlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6836),
                            IsActive = true,
                            Time = "08:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6851)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6856),
                            IsActive = true,
                            Time = "10:30",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6856)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6858),
                            IsActive = true,
                            Time = "13:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6858)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6859),
                            IsActive = true,
                            Time = "15:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6859)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6861),
                            IsActive = true,
                            Time = "17:00",
                            UpdatedAt = new DateTime(2026, 5, 12, 12, 5, 27, 235, DateTimeKind.Local).AddTicks(6861)
                        });
                });
