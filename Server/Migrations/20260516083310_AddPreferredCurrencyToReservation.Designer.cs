...
namespace ReservationSystem_backend.Migrations
{
    ...
    [Migration("20260516083310_AddPreferredCurrencyToReservation")]
    partial class AddPreferredCurrencyToReservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservationSystem_backend.Models.FlightTime", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 16, 8, 33, 8, 832, DateTimeKind.Utc).AddTicks(9145),
                            IsActive = true,
                            Time = "08:30"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 16, 8, 33, 8, 833, DateTimeKind.Utc).AddTicks(54),
                            IsActive = true,
                            Time = "10:30"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 16, 8, 33, 8, 833, DateTimeKind.Utc).AddTicks(56),
                            IsActive = true,
                            Time = "13:00"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 5, 16, 8, 33, 8, 833, DateTimeKind.Utc).AddTicks(78),
                            IsActive = true,
                            Time = "15:00"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 5, 16, 8, 33, 8, 833, DateTimeKind.Utc).AddTicks(79),
                            IsActive = true,
                            Time = "17:00"
                        });
                });
