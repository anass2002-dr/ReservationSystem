...
### 3.3 Multilingual Language Switcher
Click the flag icon in the header to switch between interface languages:
* 🇬🇧 **English (En)**
* 🇫🇷 **Français (Fr)**
* 🇸🇦 **العربية (Ar)**
...
# 9. Partner Agencies Management

**Route:** `/agencies`

Manage partner tour operators, hotel concierges, and online travel agencies:
* **Agency Cards Grid:** Displays Agency Name, Contact Person, Phone, Email, and Physical Office Address.
* **Add Agency:** Click **+ Add New Agency**, enter company details, and save.
* **Tracking Bookings:** In the Reservation Form, selecting an agency allows tracking all sales generated by each partner agency.
